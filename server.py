...
connection.execute('CREATE TABLE IF NOT EXISTS posts(name TEXT, calories TEXT, cuisine TEXT, is_vegetarian TEXT, is_gluten_free)')
...
def favorite():
    ...
    cursor = connection.cursor()
    try:
        cursor.execute('SELECT * FROM foods WHERE name = "tits"')
    except:
